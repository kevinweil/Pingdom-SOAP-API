...
public class AccountType implements java.io.Serializable {
    ...
    public static final java.lang.String _BASIC_MONTHLY = "BASIC_MONTHLY";
    public static final java.lang.String _BASIC_YEARLY = "BASIC_YEARLY";
    public static final java.lang.String _FREE = "FREE";
    public static final AccountType TRIAL = new AccountType(_TRIAL);
    public static final AccountType BASIC_MONTHLY = new AccountType(_BASIC_MONTHLY);
    public static final AccountType BASIC_YEARLY = new AccountType(_BASIC_YEARLY);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:PingdomAPI", "AccountType"));
    }
    /**
